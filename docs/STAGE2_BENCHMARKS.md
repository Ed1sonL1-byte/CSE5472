...
- **Goal hit** requires a concrete observation. The report distinguishes auxiliary validation, native startup import, native continuation, and right-censored misses at the 8 second deadline.
...
`workflow_gate` records a negative symbolic result. Native and concrete reached the goal 5/5; symbolic reached 3/5 and accepted no seed. Two symbolic repeats were right-censored, and symbolic spent a median 1.994 seconds in augmentation, reducing median native continuation to 2.670 seconds versus 4.621 for native. Concrete accepted and used nine seeds; seed-attributed children added ten projected states and 48 coverage markers across repeats. This does not establish general superiority for concrete search; it shows the cost/continuation tradeoff in this fixture and budget.
