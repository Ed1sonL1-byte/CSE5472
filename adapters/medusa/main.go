...
func runCLI(args []string) error {
	if len(args) == 0 {
		return errors.New("expected version, run-observed, decode-corpus, roundtrip, or encode-candidate")
	}
	if args[0] == "version" {
	...
	fixtureID := fs.String("fixture", "", "phase_counter or bounded_ledger")
